...
# Password reset flow (neon themed)
    path("password_reset/", views.NeonPasswordResetView.as_view(), name="password_reset"),
    path("password_reset/done/", views.NeonPasswordResetDoneView.as_view(), name="password_reset_done"),
    path("reset/<uidb64>/<token>/", views.NeonPasswordResetConfirmView.as_view(), name="password_reset_confirm"),
    path("reset/done/", views.NeonPasswordResetCompleteView.as_view(), name="password_reset_complete"),
