...
urlpatterns = [
    ...
    # Password reset flow (neon themed) ✅ FIXED (no extra "accounts/" prefix)
    path("password_reset/",
    ...
    path("reset/<uidb64>/<token>/",
         auth_views.PasswordResetConfirmView.as_view(
             template_name="accounts/emails/password_reset_confirm.html",
         ),
         name="password_reset_confirm"),

    path("reset/done/",
         auth_views.PasswordResetCompleteView.as_view(
             template_name="accounts/emails/password_reset_complete.html",
         ),
